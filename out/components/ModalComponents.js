...
exports.inputModal = exports.embedModal = void 0;
...
function inputModal() {
    const textInput = new builders_1.TextInputBuilder()
        .setLabel('Текст')
        .setCustomId('textInput')
        .setPlaceholder('Введите здесь ваш текст')
        .setMinLength(1)
        .setMaxLength(2048)
        .setStyle(discord_js_1.TextInputStyle.Paragraph)
        .setRequired(true);
    const row = new builders_1.ActionRowBuilder().addComponents(textInput);
    const modal = new builders_1.ModalBuilder()
